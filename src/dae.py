...
class Encoder(nn.Module):
    def __init__(self, options, dropout_p=0.5, q_dims=[11472, 600, 200]):
        ...
        self.linear_2 = nn.Linear(self.q_dims[1], self.q_dims[2], bias=True)
        self.tanh = nn.Tanh()
...
class MultiDAE(nn.Module):
    def __init__(self, cuda2=True, weight_decay=0.0, dropout_p=0.5, q_dims=[11472,600, 200], p_dims=[200,600, 11472]):
